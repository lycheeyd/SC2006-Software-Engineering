...
public class GlobalExceptionHandler {
    ...
    // Handle 405 Method Not Allowed - For incorrect HTTP methods (e.g., using GET instead of POST)
    ...
    // Handle 415 Unsupported Media Type - When the media type is unsupported (e.g., expecting JSON but receiving XML)
